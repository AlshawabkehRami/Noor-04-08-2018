...
public class SecurityAndSafetyManagersInDistrict {
    ...
    public void ADDSecurityAndSafetyManagersInDistrict() throws InterruptedException {
        ...
        if (ActualResult.equals(ExcpectedResult)) {
            ...
            LoginToTheUser.DirectorOfInformationTechnology();
            ...
            WebElement myInputWait1 = waitQA.until(ExpectedConditions.visibilityOfElementLocated(MyInputLocator));
            myInputWait1.sendKeys("السلامة");
            ...
            WebElement UserIdFieldLocatorWai1t1 = waitQA.until(ExpectedConditions.visibilityOfElementLocated(UserIdFieldLocator));

            UserIdFieldLocatorWai1t1.sendKeys(UserIdAfterAdded1);
