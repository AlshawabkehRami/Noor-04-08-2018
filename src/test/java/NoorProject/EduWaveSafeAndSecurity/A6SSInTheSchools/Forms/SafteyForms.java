...
package NoorProject.EduWaveSafeAndSecurity.A6SSInTheSchools.Forms;
...
public class SafteyForms {
    ...
    @Test
    public void SchoolSafetyData1() throws InterruptedException {
    ...
    //إعتماد النموذج
    public void ApproveTheForm() throws InterruptedException {
        Thread.sleep(2000);
