...
import NoorProject.EduWaveSafeAndSecurity.GeneralDirectorOfSchoolSecurityAndSafety.EduWaveSafeAndSecurityForms.ExternalItems.ExternalItems;
...
public class InternalItems {
    ...
    public void deleteInternalItems() throws InterruptedException {
        ...
        if (TableSizeForSections <= 1) {
            InternalItems AddedDelete = new InternalItems();
    ...
    public void editInternalItems() throws InterruptedException {
        ...
        if (TableSizeForSections <= 1) {
            InternalItems Added = new InternalItems();
