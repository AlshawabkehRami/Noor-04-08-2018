...
package NoorProject.EduWaveSafeAndSecurity.A3SSMangerInDistrict.ReportsMenu.BuildingAndMaintenanceReports;
...
public class BuildingData {
    ...
    private By ReportNameLoactor = By.linkText("بيانات المباني");
    ...
    public void BuildingInformationReport()   {
        ...
        browserQA.findElement(ReportNameLoactor).click();
