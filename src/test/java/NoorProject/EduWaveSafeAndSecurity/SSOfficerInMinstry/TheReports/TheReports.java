...
package NoorProject.EduWaveSafeAndSecurity.SSOfficerInMinstry.TheReports;
...
//بيانات المدرسة مع المراحل التعليمية
    ...
    public void inputRatio() throws InterruptedException {
        ...
        browserQA.findElement(ddlFormNameSearchLoactorIR).sendKeys("abdullah" , Keys.ENTER);
    ...
    public void aasessmentRateReport() throws InterruptedException {
        ...
        FormNameSearchLoactorARWait.sendKeys("abdullah" , Keys.ENTER);
